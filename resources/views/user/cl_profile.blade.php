        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                ...
                <div id="crop-avatar"> 
                  ...
                  <?php 
                  	if (isset($profile_data->profile_image) && !empty($profile_data->profile_image)) {
                  		?>
                  		<img src="<?php echo asset('/'.$profile_data->profile_image) ?>" alt="Avatar">
                  		<?php
                  	}else {
                  		?>                  		
              ...
              <h3><?php echo (isset($user_data->user_nicename)?$user_data->user_nicename:''); ?></h3>
              ...
              $loc = [];
               ...
               ?>
                <li><i class="fa fa-map-marker user-profile-icon"></i> <?php echo implode(',', $loc); ?> </li>
                <li> <i class="fa fa-briefcase user-profile-icon"></i> <?php echo (isset($profile_data->job_title)?$profile_data->job_title:''); ?> </li>
                <li class="m-top-xs"> <i class="fa fa-external-link user-profile-icon"></i> <a href="" target="_blank">www.huurr.com</a> </li>
              </ul>
              <a class="btn btn-default" href="<?php echo url('/edit/cl/profile') ?>"><i class="fa fa-edit m-right-xs"></i>Edit Profile</a> <br />
...
<!-- image cropping -->
  <script src="<?php echo asset('/cl_assets') ?>/js/cropping/cropper.min.js"></script>
  <script src="<?php echo asset('/cl_assets') ?>/js/cropping/main.js"></script>

  <!-- daterangepicker -->
  <script type="text/javascript" src="<?php echo asset('/cl_assets') ?>/js/moment/moment.min.js"></script>
  <script type="text/javascript" src="<?php echo asset('/cl_assets') ?>/js/datepicker/daterangepicker.js"></script>

  <!-- chart js -->
  <script src="<?php echo asset('/cl_assets') ?>/js/chartjs/chart.min.js"></script>

  <!-- moris js -->
  <script src="<?php echo asset('/cl_assets') ?>/js/moris/raphael-min.js"></script>
  <script src="<?php echo asset('/cl_assets') ?>/js/moris/morris.min.js"></script>
