        ...
        <div class="x_panel">
            ...
            <div class="freelancer_info">
                <div class="col-md-8 col-sm-8 col-lg-8">
                    <div class="profile_pic"> <img src="<?php if(isset($profile_data->profile_image)){ echo asset($profile_data->profile_image); }else
                        ...
                        <a href="javascript:void(0);" class="upload_profile_image">{{ __('freelancer.ChangeImage') }}</a> </div>
                    <div class="freelancer_name">
                        ...
                        <p> <i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo (isset($profile_data->city)?$profile_data->city:'').', '.(isset($profile_data->country)?$profile_data->country:'') ?> - <?php
                ...
                <div class="col-md-4 col-sm-4 col-lg-4 left-bar">
                    <div class="Available">
                        <h3   data-toggle="modal" data-target="#Available">{{ __('freelancer.Availability') }} <a href="javascript:;"><i class="fa fa-pencil-square-o edite" aria-hidden="true"></i></a> </h3>
                        ...
                        <ul class="Availablelity">
                            <li> @if(!empty($profile_data))
                                    @if(($profile_data->availability_type >=1) && empty($profile_data->not_available_text))
                                        <span style="color: green;">{{ __('freelancer.Available') }}</span>
                                    @else
                                        <span style="color: red;">{{ __('freelancer.NotAvailable') }}</span>
                                    @endif
                                @endif </li>
                            <li> @if(!empty($profile_data))
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title">{{ __('freelancer.ChangeAvailability') }}</h4>
                                            </div>
                                            <div class="modal-body">
                                                <div class="forms">
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <p>{{ __('freelancer.Info') }}</p>
                                                    <!--<p><a href="">{{ __('freelancer.Search') }}How do we use this info</a></p>-->
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <span><b>{{ __('freelancer.IAmCurrently') }}</b></span>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="submit" class="btn btn-default">{{ __('freelancer.Update') }}</button>
                                                    <a href="" class="btn-btn-default" data-dismiss="modal">{{ __('freelancer.Cancel') }}</a> </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="phone-number">
                            <h3>{{ __('freelancer.Verifications') }} <!--<a href=""><i class="fa fa-pencil-square-o edite" aria-hidden="true"></i></a>--></h3>
                            <ul class="Availablelity">
