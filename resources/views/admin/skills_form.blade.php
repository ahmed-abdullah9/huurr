        ...
        <div class="x_content"> <br/>
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_content"> <br />
                            <form id="qouts-form" enctype="multipart/form-data" method="post" data-parsley-validate action="" class="form-horizontal form-label-left">
                                {{ csrf_field() }}
