...
<div style="padding-bottom: 80px;padding-top: 20px;">
    <div style="padding-bottom: 10px;" id="frame">
        <div id="sidepanel">
            <div id="profile">
                <div class="wrap">
                    <img id="profile-img" src="<?php echo ((Session::get('profile_image') && !empty(Session::get('profile_image'))) ? url('/').'/'.Session::get('profile_image'):asset('/cl_assets/images/user.png')); ?>" class="online" alt="" />
            ...
            <div style="margin-bottom:30px;" id="search">
                ...
                <input class="padding_r_10" type="text" placeholder="{{__('freelancer.search_contacts')}}" />
            </div>
            <div id="contacts">
                <ul>
            ...
            <div class="message-input" style="z-index: 0;">
                <form id="client_message_form" method="post">
                    <div class="wrap" style="display: flex;flex-direction: row;">
                        ...
                        <input type="hidden" id="cl_id" name="client_id" class="client_id">
...
<script src="{{ asset('js/freelancer_message.js') }}"></script>