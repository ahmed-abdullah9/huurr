                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_content"> <br />
                            ...
                            <form id="qouts-form" enctype="multipart/form-data" method="post" data-parsley-validate action="{{ url('edit_qout_post')}}" class="form-horizontal form-label-left">
                                {{ csrf_field() }}
                                <h5 id="success" align="center" style="color:#933f3f;">{{__('admin.success')}}</h5>
                                <div class="form-group">
                                    <input type="hidden" name="qout_id" value="{{$qout->id}}">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="title" name="title" value="{{ $qout->title }}"  class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">{{ __('admin.title') }} <span class="required">*</span> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="ar_title" name="ar_title" value="{{ $qout->ar_title }}" class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="file" id="qouts_image" name="qouts_image" value="{{$qout->image}}"  class="form-control col-md-7 col-xs-12">
                                    ...
                                    <span> <img src="{{url('public/images/qouts')}}/{{$qout->image}}" width="100" height="100" alt="image"/></span>
                                </div>
                            ...
                            <script>
                                ...
                                $(function(){
                                    ...
                                    $("#submit_btn").click(function(event){
                                        ...
                                        $.ajax({
                                            url:'<?php echo url('/edit_qout_post/'); ?>',
                                            data:formData,
                                            async:false,
                                            type:'POST',
                                            processData: false,
