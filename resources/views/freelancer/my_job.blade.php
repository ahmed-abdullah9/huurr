@include ('include/header_fr')<div class="col-md-12 col-sm-12 col-xs-12">  <div class="x_panel">    <div class="x_title">      <h2 class="table-heading">Freelancer Jobs </h2>      <div class="clearfix"></div>    </div>    <div class="x_content">	      <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">        <thead class="table-header-colums-title">          <tr>            <th>{{ __('freelancer.ProjectName') }}</th>   <th>Amount</th>         <th>{{ __('freelancer.Skills') }}</th>            <th>{{ __('freelancer.StartDate') }}</th>            <th>{{ __('freelancer.EndDate') }}</th>            <th>{{ __('freelancer.Content') }}</th>            <th>{{ __('freelancer.Feedback') }}</th>          </tr>        </thead>
